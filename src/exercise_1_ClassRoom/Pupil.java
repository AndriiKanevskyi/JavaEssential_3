...
public class Pupil {
    ...
    public void study(){
        System.out.println("Звичайний учень вчиться на середньому рівні");
    }

    public void read(){
        System.out.println("Звичайний учень читає на середньому рівні");
    }

    public void write(){
        System.out.println("Звичайний учень пише на середньому рівні");
    }

    public void relax(){
        System.out.println("Звичайний учень відпочиває так як всі інші,зазвичай переглядає телевізор");
    }
